        ...
        <div class="row full-height justify-content-center">
          <div class="col-12 text-center align-self-center py-5">
            <div class="section pb-5 pt-5 pt-sm-2 text-center">
              <h6 class="mb-0 pb-3"><span>Editar hóspede</span></h6>
                  ...
                  <div class="card-front">
                    <div class="center-wrap">
                      <div class="section text-center">
                        ...
                        <?php include_once "../update_tables/editar_hospede.php"; ?>

                        <form action="../update_tables/editar_hospede_salvar.php" method="POST">
                            <input type="hidden" name="idHospede" value="<?= $result['id_hospede']; ?>">
