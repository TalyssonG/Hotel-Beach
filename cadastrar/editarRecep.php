...
<head>
  ...
  <link rel="stylesheet" href="../css/cadastrarRecep.css">
  <!-- Fontes -->
        ...
        <div class="row full-height justify-content-center">
          <div class="col-12 text-center align-self-center py-5">
            <div class="section pb-5 pt-5 pt-sm-2 text-center">
              <h6 class="mb-0 pb-3"><span>Editar recepcionista</span></h6>
                  ...
                  <div class="card-front">
                    <div class="center-wrap">
                      <div class="section text-center">
                        ...
                        <?php include_once "../update_tables/editar_recep.php"; ?>

                        <form action="../update_tables/editar_recep_salvar.php" method="POST">
                            <input type="hidden" name="idRecep" value="<?= $result['id_recepcionista']; ?>">
                          ...
                          <div class="form-group mt-2">
                            <input type="text" name="rg" class="form-style" placeholder="RG" id="logpass"
                              autocomplete="off" value="<?= $result['rg']; ?>">
                            <i class="input-icon uil uil-lock-alt"></i>
                          </div>
                          <div class="form-group mt-2">
